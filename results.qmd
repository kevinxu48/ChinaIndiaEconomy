...
yoyc_China <- yoy_comp %>% filter(year >= 2019 & Country == "China") %>%
  ggplot() +
  geom_col(aes(x = year, y = value, fill = indicator), position = "dodge", width = 1) +
  scale_fill_brewer(palette = "Reds", direction = -1) + 
  geom_vline(xintercept = 2019.5, color = "grey", size = 0.5) +
  geom_vline(xintercept = 2020.5, color = "grey", size = 0.5) +
  geom_vline(xintercept = 2021.5, color = "grey", size = 0.5) +
  kv_theme() + 
